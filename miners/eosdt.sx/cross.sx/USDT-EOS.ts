...
import { eosdtSx, crossSx, flash, newdex } from "../../../plugins"
...
export async function mine( account: Name ) {
    ...
    // calculations
    const rate = await eosdtSx.get_calculate_rate( quantity, quote.get_symbol().code() );
    ...
    const actions = [
        ...
        eosdtSx.buymarket( account, base.get_contract(), quantity, quote.get_symbol().code() ),
