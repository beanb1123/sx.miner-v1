...
import { vigorSx, crossSx, flash, newdex } from "../../../plugins"
...
export async function mine( account: Name ) {
    ...
    // calculations
    const rate = await vigorSx.get_calculate_rate( quantity, quote.get_symbol().code() );
    ...
    const actions = [
        ...
        vigorSx.buymarket( account, base.get_contract(), quantity, quote.get_symbol().code() ),
